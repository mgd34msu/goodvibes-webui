...
export function AdminView({ realtimeError }: AdminViewProps) {
  ...
  // Config/settings surface: per the platform's surface doctrine ("modals
  // become a configuration surface"), the config.get/set editor lives in a
  // modal (SettingsModal), not an always-visible page section.
